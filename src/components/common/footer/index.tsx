...
const Footer: React.FC = () => {
    ...
    const footerSections = {
        ...
        contact: {
            ...
            items: [
                {
                    label: "example@riffhouse.com",
                    href: "mailto:example@riffhouse.com",
                    icon: "pi-envelope",
                },
                {
                    label: "(99) 9999-9999",
            ...
            <div className="footer-container">
                ...
                <div className="footer-logo-section">
                    ...
                    <p className="footer-tagline">
                        Instrumentos musicais de qualidade para músicos
                        exigentes
                    </p>
                </div>
                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-column">
                        <h3 className="footer-title">
                            {footerSections.institutional.title}
                        </h3>
                        <ul className="footer-list">
                            {footerSections.institutional.items.map(
                                (item, index) => (
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        &copy; {currentYear} RiffHouse. Todos os direitos
                        reservados.
                    </p>
                    <p className="footer-credits">
                        Desenvolvido com <i className="pi pi-heart"></i> pela
                        equipe RiffHouse
                    </p>
                </div>
            </div>
