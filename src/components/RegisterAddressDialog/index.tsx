...
export const RegisterAddressDialog: React.FC< {
    ...
    return (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div>
                <label htmlFor="street" style={{ display: "block", marginBottom: "0.5rem", fontWeight: "600" }}>
                    Rua *
                </label>
                <InputText
                    id="street"
                ...
                <div>
                    ...
                    onChange={(e) => setNewAddress({ ...newAddress, number: Number(e.value) })}
                    placeholder="Número"
                    />
                </div>
                <div>
                    <label htmlFor="complement" style={{ display: "block", marginBottom: "0.5rem", fontWeight: "600" }}>
                    Complemento
                    </label>
                    <InputText
                    id="complement"
                ...
                <div>
                <label htmlFor="neighborhood" style={{ display: "block", marginBottom: "0.5rem", fontWeight: "600" }}>
                    Bairro *
                </label>
                <InputText
                    id="neighborhood"
